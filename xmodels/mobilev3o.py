...
mobilenetv3_small = MobileNetV3(model_mode="small", num_classes=1000, multiplier=1.0)
mobilenetv3_large = MobileNetV3(model_mode="large", num_classes=1000, multiplier=1.0)
...
if __name__ == '__main__':
    ...
    model = [mobilenetv3_large, mobilenetv3_small][1]
    print('\n', model, '\n')

    # load error
    ckpt = ['mobilev3_o_large_xxxxxxx.t7', 'mobilev3_o_small_xxxxxxx.t7'][1]
    model.load_state_dict(torch.load('/data/zhangjp/PreTrainedModels/%s' % ckpt))

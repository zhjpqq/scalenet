...
Andrew Howard, Mark Sandler, Grace Chu, Liang-Chieh Chen, Bo Chen (2019).
...
def mobilenetv3_large(**kwargs):
    ...
    5.145M	245.58	 73.152 / 91.102
    Prec@1-64.322 Prec@5-84.216
    """
    cfgs = [
        # k, t, c, SE, NL, s
        [3, 16, 16, 0, 0, 1],
...
if __name__ == '__main__':
    import xtils, torch, os

    model = [mobilenetv3_small(), mobilenetv3_large()][0]
    print('\n', model, '\n')

    ckpt = ['mobilev3_y_small-c7eb32fe.pth', 'mobilev3_y_large-657e7b3d.pth'][0]

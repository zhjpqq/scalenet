...
"""
  WaveDenseNet => AffineBlock + RockBlock + DoubleCouple + SingleCouple 
                  + Summary(+merge +split) + BottleNeck(暂无)
  
  DoupleCouple 和 SingleCouple 有且只有 Plain 模式, 无BottleNeck模式
"""
...
class WaveNet(nn.Module):
    ...
    def _make_dense_stage(self, block, nums, indepth, growth, cfy, after, trans, reduce,
